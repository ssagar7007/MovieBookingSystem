package com.sagar.MovieBookingSystem.Security;
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0")
                        .description("API documentation for JWT-secured Movie Booking System with distributed seat locking and transactional consistency"))
